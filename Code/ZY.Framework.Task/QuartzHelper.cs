...
namespace ZY.Framework.Task
{
    /// <summary>
    /// Quartz.Net辅助类
    /// <para>基于数据池的定时任务</para>
    /// <example>
    /// QuartzHelper.ExecuteAtTime(CheckOrderJob, "0/2 * * * * ?", null, "CheckOrderJob");
    /// public static void CheckOrderJob(Dictionary<string, object> args);
    /// </example>
    /// <remarks>感谢@周健韬</remarks>
    /// </summary>
